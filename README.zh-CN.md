...
**Android 预览版：** [原生钱包源码与构建说明](android/README.md) · [公开 Android 构建](https://github.com/TeraWalletRH/TeraWallet/actions/workflows/android.yml)。可创建或导入助记词，并在设备上签名。正式发布前仍需完成真机测试。
