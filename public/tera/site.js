...
function translatePage(lang){
 ...
 nodes.forEach(n=>{if(n.parentElement?.closest('script,style,select'))return;const raw=n.nodeValue||'';const key=raw.trim();if(!key)return;if(!n.__teraEnglish)n.__teraEnglish=key;const value=lang==='zh'?zhText[n.__teraEnglish]||key:n.__teraEnglish;if(value&&value!==key)n.nodeValue=raw.replace(key,value)});
